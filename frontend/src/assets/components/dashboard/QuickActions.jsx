  ...
  return (
    <div className="mb-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div onClick={() => navigate("/dashboard/description")} className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col gap-3 shadow-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col gap-3 shadow-sm">
          ...
          <p className="text-xs text-gray-500">
            Create ingredient benefits and highlights.
          </p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col gap-3 shadow-sm">
          ...
          <h3 className="font-semibold text-gray-900">Packaging Content</h3>
          <p className="text-xs text-gray-500">
            Create packaging text or business introduction
          </p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col gap-3 shadow-sm">
          ...
          <h3 className="font-semibold text-gray-900">Marketplace Listing</h3>
          <p className="text-xs text-gray-500">
            Generate content for marketplaces.
          </p>
