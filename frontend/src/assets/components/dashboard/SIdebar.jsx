...
import {
  LayoutDashboard, Package, History, User, Settings, LogOut, Bell,
} from "lucide-react";
    ...
    <aside className="flex flex-col h-full w-64 bg-[#1a2332] flex-shrink-0">
      ...
      <div className="h-[72px] flex items-center px-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-xl bg-orange-500 flex items-center justify-center font-bold text-sm text-white">
            P
          </div>
